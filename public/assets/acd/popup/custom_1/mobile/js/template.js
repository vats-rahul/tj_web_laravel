...
tj.acdPopupTemplate.custom_1.renderSlider = function (sliderParam = {}) {
    ...
    tj.acdPopupTemplate.custom_1.loadScript('tj-slick-js',tj.acdPopupVariables['tjUrl'][up.en] + '/assets/V2/js/slick.min.js')
    .then(() => {
        tj.acdPopupTemplate.custom_1.loadCss('tj-slick-css',tj.acdPopupVariables['tjUrl'][up.en]+'/assets/V2/css/slick/slick-comb.css');
...
tj.acdPopupTemplate.custom_1.loadScript = function(e, src) {
    if (!document.getElementById(e)) {
        ...
        (tj.s.id = e),
        (tj.s.async = true);
        document.body.appendChild(tj.s);
...
tj.acdPopupTemplate.custom_1.loadCss = function (e, src) {
    if (!document.getElementById(e)) {
