...
tj.acdPopupTemplate.download_product = {
    ...
    initFormActions: function () {
        document.getElementsByClassName("acdPopupCampaignName").defaultValue = $(".acdPopupCampaignName").data("source") + " ACD Pop-up2";
    ...
    change_form_content: function (data) {
        ...
        if (tj.acdPopupVariables['default_product_id'] == data.product_id) {
            ...
            document.getElementById('viewsimilar').innerHTML = 'View All Softwares';
        }
...
tj.acdPopupTemplate.download_product.bindEvents = function () {
                ...
                if (e.status) {
                    ...
                    if (tj.acdPopupVariables['device_type'] == 'desktop') {
                        set_html = `<div class="rec-img" style="width:30%">
                                        <img class="confimed-img" src="${tj.acdPopupVariables['tjUrl'][up.en] +
                            '/assets/acd/popup/desktop/images/check.svg'
                            }" alt="${e.data.product_name
                            }" width="40px"/>
                                    </div>
                    ...
                    if (tj.acdPopupVariables['device_type'] == 'desktop') {
                        error_html = `<div class="rec-img" style="width:30%">
                            ...
                            '/assets/new-assets/images/error.svg'
                                    ...
                                    <div style="font-size:11px;float:left;">
                                        Sorry! Partner is occupied.
                                    </div>
                                    <div class="star-acd-2">
                                        <a href="${tj.acdPopupVariables['tjUrl'][up.en] + '/alternatives/' + slug}" class="rec-img-3">Similar Products</a>
                                    </div>`;
                    } else {
                        error_html = `div class="rec-img-2">
                                <h3 style="display: block;width: 100%;white-space: nowrap; overflow: hidden;text-overflow: ellipsis;">Confirmed!</h3>
                                <div style="font-size:11px;float:left;">
                                    Sorry! Partner is occupied..
                                </div>
    ...
    $('.show_email_info').click(function () {
        $('.email_info').toggle();
    });

    $('.industry-q1').click(function(event) {
        if (!$(event.target).closest('.show_email_info, .email_info').length) {
            $('.email_info').hide();
        }
    });
