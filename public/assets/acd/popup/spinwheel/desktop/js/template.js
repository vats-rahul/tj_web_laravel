...
tjspingamelib.acdPopupTemplate.spinwheel = {
    ...
    createSpinWheelChart: function () {
        ...
        var svg = d3.select('#chart')
                ...
                .attr("width", tjspingamelib.chart.w + tjspingamelib.chart.padding.left + tjspingamelib.chart.padding.right)
                .attr("height", tjspingamelib.chart.h + tjspingamelib.chart.padding.top + tjspingamelib.chart.padding.bottom);
        svg.append("circle")
                .attr("cx", 0)
                .attr("cy", 0)
