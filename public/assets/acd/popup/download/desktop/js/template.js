...
tj.acdPopupTemplate.download = {
    ...
    change_form_content: function (data) {
        ...
        if(tj.page_type == "compare") {
            document.getElementById('left-confirmation-msg') && (document.getElementById('left-confirmation-msg').innerHTML = 'Your Free Comparison <br> is Downloaded');
            document.getElementById('tj-third-msg-first') && (document.getElementById('tj-third-msg-first').innerHTML = 'Awesome, Your Free Comparison<br> is Downloaded!');
        }
...
tj.acdPopupTemplate.download.bindEvents = function () {
    ...
    $(document).on('click', '.tj-acd-form-recommended-product', function () {
        ...
        t['user_intent'] = $(this).data('userintent') || 'Download';
...
function downloadPDF(){
    ...
    if(tj.page_type == "compare") { 
        tj.loadScript('tj-jspdf','https://cdnjs.cloudflare.com/ajax/libs/jspdf/2.4.0/jspdf.umd.min.js')
            .then(() => {      
                tj.loadScript('tj-html2pdf','https://cdnjs.cloudflare.com/ajax/libs/html2pdf.js/0.10.1/html2pdf.bundle.min.js')
                    .then(() => {      
                        ...
                        var options = {
                            ...
                            jsPDF: { unit: 'in', format: [15,25], orientation: 'portrait' },
                        };
